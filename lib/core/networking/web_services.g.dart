...
class _WebServices implements WebServices {
  ...
  Future<Kid> createNewKid(Kid newkid) async {
    ...
    late Kid _value;
    try {
      _value = Kid.fromJson(_result.data!);
    } on Object catch (e, s) {
  ...
  Future<Instructor> createNewInstructor(Instructor newinstructor) async {
    ...
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
    _data.addAll(newinstructor.toJson());
    final _options = _setStreamType<Instructor>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
    )
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late Instructor _value;
    try {
      _value = Instructor.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
  ...
  Future<User> loginUserInstructor(User logininstructor) async {
    ...
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
    _data.addAll(logininstructor.toJson());
    final _options = _setStreamType<User>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
